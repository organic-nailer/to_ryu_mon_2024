...
/// The [MySpawnComponent] is a non-visual component which can spawn
...
/// {@endtemplate}
class MySpawnComponent extends Component {
  ...
  ///
  /// [amount] is the amount of components that the [MySpawnComponent] has spawned
  /// so far.
